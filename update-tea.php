...
// error_reporting(0);
     ...
     $query = "UPDATE tea_reg set fname='$fname', lname='$lname', fathername='$fathername', gender='$gender', category='$category', dob='$dob', email='$email', ph='$ph', course='$course', address='$address', state='$state', pincode='$pincode' WHERE id='$id'";
...
?>
    <div class="wrapper">
        ...
        <form action="update-tea.php" method="POST" enctype="multipart/form-data" data-netlify="true">
            <div class="form">
