...
<body> 
   ...
   <section class="table__header">
       <h2>Welcome to</h2>
       <h1 class="lg_text">Batch Record</h1>
   ...
   <th width=15%>Batch Id  <span class="icon-arrow">&UpArrow;</span></th>
   <th width=15%>Batch Name  <span class="icon-arrow">&UpArrow;</span></th>
   <th width=15%>Batch Year <span class="icon-arrow">&UpArrow;</span></th>  
    ...
    
    {
        ...
        "<tr>
          ...
          <td>
            ...
            <a href='delete-bt.php?id=$result[id]'><input type='submit' value='delete' class='delete' onclick = 'return checkdelete()'></a></td>
